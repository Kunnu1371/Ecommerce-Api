...
router.post('/trendingCategory/create/:categoryId/:adminId', requireSignin, isAdmin, isAuth, createTrendingCategory)
...
// requests for subcategory
router.get('/trendingSubCategory/:trendingSubCategoryId', readTrendingSubCategory)
router.post('/trendingSubCategory/create/:subcategoryId/:adminId', requireSignin, isAdmin, isAuth, createTrendingSubCategory)
...
router.post('/trendingProduct/create/:productId/:adminId', requireSignin, isAdmin, isAuth, createTrendingProduct)
