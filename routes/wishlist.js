...
const { addToWishlist, getWishlistItems, deleteWishlistItems, moveToCart, checkProduct } = require('../controllers/wishlist')
...
router.get('/wishlist/:productId/:userId', requireSignin, isAuth, checkProduct)
